...
export const PHASE_TWO_SOURCE_INVENTORY = Object.freeze({
  ...
  excludedWorksheets: freezeEntries([
    {
      sheetName: 'MTD YTD',
      reason: 'Not required for the normalized Phase 2 daily datasets.'
    },
    {
...
export const PHASE_TWO_REQUIRED_SHEETS = Object.freeze([
  PHASE_TWO_SOURCE_INVENTORY.dailyVolume.sheetName,
  PHASE_TWO_SOURCE_INVENTORY.ticketProductivity.sheetName,
  PHASE_TWO_SOURCE_INVENTORY.dailyDrivers.sheetName
])
