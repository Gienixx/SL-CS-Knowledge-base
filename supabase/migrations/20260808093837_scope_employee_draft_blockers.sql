drop function if exists public.payroll_calculate_draft(uuid, uuid); drop function if exists public.payroll_calculate_employee_draft(uuid);
...
revoke all on function public.payroll_calculate_draft(uuid) from public, anon;
revoke all on function public.payroll_calculate_draft(uuid, uuid) from public, anon;
revoke all on function public.payroll_calculate_employee_draft(uuid) from public, anon;
grant execute on function public.payroll_calculate_draft(uuid) to authenticated, service_role;
grant execute on function public.payroll_calculate_draft(uuid, uuid) to authenticated, service_role;
grant execute on function public.payroll_calculate_employee_draft(uuid) to authenticated, service_role;
