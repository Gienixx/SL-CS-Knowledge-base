drop function if exists public.payroll_import_attendance(uuid, uuid); drop function if exists public.payroll_import_employee_attendance(uuid);
...
revoke all on function public.payroll_import_attendance(uuid, uuid) from public, anon;
revoke all on function public.payroll_import_employee_attendance(uuid) from public, anon;
grant execute on function public.payroll_import_attendance(uuid) to authenticated, service_role;
grant execute on function public.payroll_import_attendance(uuid, uuid) to authenticated, service_role;
grant execute on function public.payroll_import_employee_attendance(uuid) to authenticated, service_role;
