...
begin
  ...
  if v_attendance.work_date <= v_period.payment_date or v_attendance.work_date > v_period.period_end then
  ...
  insert into public.payroll_schedule_snapshots (
    ...
    approval_reason, source_type, source_metadata
  ) values (
    ...
    v_actor, statement_timestamp(), v_reason, 'historical_restore',
